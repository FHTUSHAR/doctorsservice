...
const Blog = () => {
    return (
        <div className='text-center flex justify-center'>
            ...
            <div className='w-1/2 '>
                <div className='border  mt-5 p-4 rounded-md shadow-md shadow-slate-700 bg-slate-800 text-white'>
                ...
                <div className='border  mt-5  p-4 rounded-md shadow-md shadow-slate-700 mb-3 bg-slate-800 text-white'>
